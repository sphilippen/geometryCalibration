...
#METAPROJECT /cvmfs/icecube.opensciencegrid.org/users/sphilippen/icetray/buildCUDA/
import os
import sys
...
parser.add_argument("string", type=int, help="flashing string")
parser.add_argument("dom", type=int, help="flashing DOM")
...
gcdfile = "/data/exp/IceCube/2017/filtered/level2pass2/0101/Run00129004/Level2pass2_IC86.2016_data_Run00129004_0101_89_290_GCD.i3.zst"
...
fstr = args.string  # flashing string
fdom = args.dom  # flashing DOM
...
mask = 0b111111000000 #0b000000000001 # bitmask controlling which LEDs are turned on, 0 for off, 1 for on
